...
flashCalEO(z(3,:), P(3), x(2,1:4), y(2,1:4), vf(3), T(3),...
           Zl(2), Zv(2), sl(2), sv(2), beta(2) , rho, 'PH', h(3));
...
flashCalEO(z(5,:), P(5), x(3,1:4), z(5,1:4), vf(5), T(5),...
...
[x(15,:), y(15,:), vf(15), T(15), Zl(15), Zv(15), ...
 ...
 flashCalEO(z(15,:), P(15), y(3,1:4), y(3,1:4), vf(15), T(6) , Zl(3), Zv(3),...
